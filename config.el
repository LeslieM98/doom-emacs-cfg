...
(setq doom-one-brighter-comments (not(display-graphic-p)))
...
;; they are implemented.("\\.\\([pP]\\([Llm]\\|erl\\|od\\)\\|al\\)\\'" . perl-mode)

(setq auto-mode-alist (delete '("\\.\\([pP]\\([Llm]\\|erl\\|od\\)\\|al\\)\\'" . perl-mode) auto-mode-alist))
